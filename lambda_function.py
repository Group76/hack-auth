...
def lambda_handler(event, context):
    ...
    try:
        decoded_token = jwt.decode(token, 'd8e45755249ca02070d6a9786ddb3c5521e172ed167b8c31cba588368ed3348b', algorithms=['HS256'])
        id_patient = decoded_token['id']
    ...
    try:
        response = table.get_item(Key={'id': id_patient})
    ...
    return generate_policy(id_patient, 'Allow', method_arn)
